...
<html>
  ...
  <div id="header" style='display:block;margin: 0px;overflow-x:auto;'>
    <div id="header-links" style='display:block;width:1000px;margin-top: 0px;margin-right: auto;margin-bottom: 0px;margin-left: auto;padding:5px;'>
        <a class="header_main" style="padding:0;" href="/propeller">PropLec</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/propeller/search">Advanced search</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/propeller/domains">Domains</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/propeller/tutorial">Tutorial</a>
        ...
        <a class="header_main" style="padding:0;" href='/'>UniLectin</a>
