...
<html>
  ...
  <div id="header" style='display:block;margin: 0px;overflow-x:auto;'>
    <div id="header-links" style='display:block;width:1000px;margin-top: 0px;margin-right: auto;margin-bottom: 0px;margin-left: auto;padding:5px;'>
        <a class="header_main" style="padding:0px;margin:0;font-size: 20px;" href="/predict">LectomeXplore</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/predict/search">Search by field</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/predict/domains">Architectures</a>
        <a class="btn-lg btn-primary" style="vertical-align: middle;" href="/predict/tutorial">Tutorial</a>
        ...
        <div style="vertical-align: middle;display: inline-flex;margin:0px;vertical-align:center;width: 200px;height: 40px;background-color: #24292e;color: #4c4c4c;border:1px solid black;">
        ...
        <a class="header_main" style="padding:0px;margin:0;font-size: 20px;" href='/'>UniLectin</a>
